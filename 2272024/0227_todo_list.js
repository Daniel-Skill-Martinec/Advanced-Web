...
function renderTodoList() {
    ...
    document.querySelector('.js-todo-list-items').innerHTML = todo_list_html;
}
...
function addToDo() {
    ...
    const date_elem = document.querySelector('.js-date');
    const due_date = date_elem.value;
    //console.log(due_date);

    todo_list.push({
        name, // shortcut for name: name
        due_date // shortcut for due_date: due_date
    });
